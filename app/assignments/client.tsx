...
export default function AssignmentsClient({ initialAssignments }: { initialAssignments: any[] }) {
    ...
    const filteredAssignments = initialAssignments.map((a, i) => ({
        ...a,
                    ...
                    <DialogContent className="max-w-lg">
                        ...
                        <form onSubmit={handleAddAssignment} className="grid gap-4 py-4">
                            <div className="grid gap-2">
                                ...
                                <Input name="title" id="title" placeholder="Assignment title" required />
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input name="points" id="points" type="number" placeholder="100" defaultValue="100" />
                                </div>
                            </div>
                                            ...
                                            <div className="flex items-start gap-4 flex-1">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center gap-4 mt-3 text-sm text-muted-foreground flex-wrap">
                                                        ...
                                                        <Badge variant="outline">{assignment.class?.className || "Class"}</Badge>
