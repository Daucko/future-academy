                        ...
                        <div className="max-w-[1000px] mx-auto flex flex-col gap-6">
                            ...
                            <Card className="border-slate-200 dark:border-slate-800 overflow-hidden">
                                <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-slate-900 sticky top-0 z-10">
                                    <h3 className="font-semibold text-lg text-slate-900 dark:text-white">Daily Schedule</h3>
                                        ...
                                        {timetableItems.map((item, index) => (
                                            <div key={index} className="contents">
                                                ...
                                                <div className="text-right pt-4 pr-3">
                                                    <span className={`text-sm font-medium ${item.status === 'current'
                                                ...
                                                {/* Content Column */}
                                                <div className={`pb-8 pt-0 pl-2 ${index === timetableItems.length - 1 ? 'pb-0' : ''}`}>
                                                    {item.type === 'break' ? (
                                                        <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/20 border-dashed rounded-xl p-3 flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                <h4 className="font-medium text-slate-900 dark:text-white text-sm">{item.title}</h4>
                                                                <p className="text-xs text-slate-500 dark:text-slate-400">{item.location} • {item.duration}</p>
                                                            </div>
                                                        </div>
                                                    ) : (
                                                        <div className={`
                            ...
                            `}>
                                                            <div className="relative z-10">
                                                                <div className="flex justify-between items-start mb-2">
                                                                    <h4 className={`font-bold ${item.status === 'current'
